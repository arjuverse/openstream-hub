...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_channels_category"), "channels", ["category"], unique=False
    )
    op.create_index(op.f("ix_channels_country"), "channels", ["country"], unique=False)
    op.create_index(
        op.f("ix_channels_group_title"), "channels", ["group_title"], unique=False
    )
    op.create_index(op.f("ix_channels_id"), "channels", ["id"], unique=False)
    op.create_index(
        op.f("ix_channels_language"), "channels", ["language"], unique=False
    )
